...
void Debug::DrawRectangle(float x, float y, float m_windowWidth, float m_windowHeight, const sf::Color& color)
{
	DrawLine(x, y, x + m_windowWidth, y, color);
	DrawLine(x + m_windowWidth, y, x + m_windowWidth, y + m_windowHeight, color);
	DrawLine(x + m_windowWidth, y + m_windowHeight, x, y + m_windowHeight, color);
	DrawLine(x, y + m_windowHeight, x, y, color);
}
...
void Debug::DrawOutCircle(float x, float y, float radius, const sf::Color& color)
{
	sf::CircleShape circle;

	circle.setRadius(radius);
	circle.setOutlineColor(color);
	circle.setOutlineThickness(5); //La taille de l'épaisseur
