...
public:
	...
	static void DrawRectangle(float x, float y, float m_windowWidth, float m_windowHeight, const sf::Color& color);
	static void DrawCircle(float x, float y, float radius, const sf::Color& color);
	static void DrawOutCircle(float x, float y, float radius, const sf::Color& color);
