...
void GameManager::CreateWindow(unsigned int m_windowWidth, unsigned int m_windowHeight, const char* title, int fpsLimit, sf::Color clearColor)
{
	_ASSERT(mpWindow == nullptr);

	mpWindow = new sf::RenderWindow(sf::VideoMode(m_windowWidth, m_windowHeight), title);
